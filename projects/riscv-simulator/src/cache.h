...
// Milestone 4 cache configuration: the unified L2 sits behind L1-I and L1-D and
// is larger/more associative than L1. Configuration-only, per the MS1 rule that
// cache.h may be edited for cache configurations.
...
#define L2_CACHE_BLOCK_BITS 6     // L2 block size (2^L2_CACHE_BLOCK_BITS), matches L1
